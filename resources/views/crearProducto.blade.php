...
<body>
    ...
    <center>
        <div class="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('producto.guardar')}}" method="post">
                @csrf
                @method('POST')
                <div class="mb-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{route('producto.inicio')}}" class="btn btn-info">Regresar</a>
